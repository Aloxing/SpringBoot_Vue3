...
//刷新
const SX=()=>{
  axios.get(url+'/api/sat/words',{params:{currentPage:currentPage.value,pageSize:pageSize.value}})
      .then(res => {
...
axios.get(url+'/api/sat/words/sum')
    .then(res => {
...
const dwSelect=()=>{
  ...
  axios.get(url+'/api/sat/words/select',{params:{word:dwData.value}})
      .then(res => {
        tableData.value=res.data
      })
      .catch(err => {
...
const xsSelect=()=>{
  ...
  axios.get(url+'/api/sat/words/selectany',{params:{word:xsData.value}})
      .then(res => {
        tableData.value=res.data
      })
      .catch(err => {
